...
def main():
    ...
    while True:
        ...
        if weighted_score > 4:
            classification_text = "Suspected Virtual"
            text_color = (0, 0, 255)  # Red for suspected virtual
        else:
            classification_text = "Likely Real"
        ...
        cv2.putText(overlayed_frame, classification_text, (10, 90), font, 3, text_color, 1)
        ...
        cv2.imshow('Virtual Camera Footage', overlayed_frame)
